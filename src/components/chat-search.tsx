...
import { fetcher, formatDate, groupChatsByDate } from '@/lib/utils';
...
// ChatSearch component with compound pattern
function ChatSearch({ open, onOpenChange }: Props) {
...
// Define Trigger as a static property
ChatSearch.Trigger = function ChatSearchTrigger({
  onClick,
}: { onClick: () => void }) {
  return (
    <Button
